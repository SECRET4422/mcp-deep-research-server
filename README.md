...
<p align="center">
  [![MCPize](https://mcpize.com/badge/@SECRET4422/deep-research)](https://mcpize.com/mcp/deep-research)
...
```bash
npx -y mcpize connect @SECRET4422/deep-research --client claude
```

Or connect at: **https://mcpize.com/mcp/deep-research**
